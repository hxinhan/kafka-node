...
ConsumerGroup.prototype.saveDefaultOffsets = function (topicPartitionList, callback) {
  logger.debug('TROUBLESHOOT saveDefaultOffsets topicPartitionList: ', topicPartitionList)
  var self = this;
  ...
  logger.debug('TROUBLESHOOT saveDefaultOffsets offsetPayload: ', offsetPayload)
